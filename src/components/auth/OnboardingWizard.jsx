                ...
                return (
                    <div className="space-y-6">
                        ...
                        <div className="flex gap-4">
                            ...
                            <button onClick={handleComplete} disabled={!data.city} className="flex-1 py-3 bg-text-primary text-bg-primary rounded-lg font-bold hover:opacity-90 disabled:opacity-50 transition-all">
                                Complete Setup
                            </button>
                        </div>
                    </div>
