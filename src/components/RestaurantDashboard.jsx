    ...
    const handleMenuUpload = (e) => {
        ...
        setTimeout(() => {
            const extractedItems = [
                { id: Date.now() + 1, item: 'Jollof Base', category: 'Pantry', stock: 'Medium', status: 'Active' },
                { id: Date.now() + 2, item: 'Goat Meat', category: 'Protein', stock: 'High', status: 'Active' },
                { id: Date.now() + 3, item: 'Tiger Nuts', category: 'Produce', stock: 'Low', status: 'Active' },
            ];
            setInventory(prev => [...prev, ...extractedItems]);
            setAnalyzingMenu(false);
            alert("Menu Analysis Complete! Added 3 new items identified from the document.");
        }, 3000); // 3 second delay
    };
                ...
                <header className="mb-6 md:mb-12 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    ...
                    <div className="flex gap-4">
                        <div className="glass-panel px-4 py-2 flex items-center gap-2">
                            ...
                            <span className="text-xs font-mono font-bold text-text-primary">System Online v2.1</span>
                        </div>
                    </div>
                </header>
                ...
                {activeTab === 'inventory' && (
                    <div className="animate-[fadeIn_0.3s]">
                        <div className="flex justify-between items-end mb-6">
                            <div>
                                <h2 className="text-xl font-bold text-text-primary mb-1">Current Stock</h2>
                                <p className="text-xs text-text-secondary">Manage your real-time ingredients.</p>
                            </div>
                        ...
                        {analyzingMenu && (
                            <div className="glass-panel p-6 mb-8 flex items-center gap-6 animate-pulse border-accent-jp/30 border">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-text-secondary">Extracting ingredients, categorizing items, and mapping flavor profiles.</p>
                                </div>
                            </div>
                        )}
