        ...
        return (
            <div className="min-h-screen w-full bg-bg-primary flex flex-col md:flex-row">
                ...
                <main className="flex-1 p-4 md:p-12 bg-bg-secondary/30">
                    ...
                    {/* --- INSIGHTS VIEW --- */}
                    {/* Define renderInsights function */}
                    {/* Assuming this is inside the RestaurantDashboard component function */}
                    {(() => {
                        // This is a placeholder for where the renderInsights function would be defined
                        // For example:
                        // const renderInsights = () => { ... };
                        // Since the full component context is not provided,
                        // I'm placing the function definition here as an IIFE for demonstration
                        // within the given snippet's constraints.
                        // In a real React component, this would be a named function
                        // defined within the component's scope.
                    })()}
                    {activeTab === 'insights' && (() => {
                        const renderInsights = () => {
                            console.log('Rendering Insights. Status:', approvalStatus, insights);
