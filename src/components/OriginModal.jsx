            ...
            >
                ...
                >
                    ...
                    <div className="relative z-10 w-full flex flex-col md:flex-row">
                        ...
                        {/* Left Panel: Content */}
                        <div className="w-full md:w-[50%] relative z-20 pointer-events-none pt-10 md:pt-16 pb-[50px] pl-10 md:pl-16 pr-10 md:pr-24 bg-black/20 backdrop-blur-md border-r border-white/5 rounded-r-3xl">
